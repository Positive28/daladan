                  ...
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <span
                      className={`rounded-full px-3 py-1 text-xs font-semibold ${
                        index === 0 ? 'bg-daladan-primary/10 text-daladan-primary' : 'bg-slate-200 text-slate-600'
                      }`}
                    >
                  ...
                  <div className="mt-4 grid gap-2 sm:grid-cols-[1fr_1fr_auto]">
                    ...
                    <Link
                      ...
                      className={`rounded-xl px-4 py-2 text-center text-sm font-semibold ${
                        index === 0 ? 'bg-daladan-accentMuted text-daladan-accentDark' : 'bg-slate-200 text-slate-600'
                      }`}
                    >
        ...
        <div className="space-y-1 text-sm">
          <button
            ...
            className={`flex w-full items-center gap-2 rounded-lg px-3 py-2 text-left font-medium ${
              activeTab === 'profile' ? 'bg-daladan-primary/10 text-daladan-primary' : 'text-slate-600'
            }`}
          >
            <Eye size={16} />
            Profil
          ...
          <button
            ...
            className={`flex w-full items-center gap-2 rounded-lg px-3 py-2 text-left font-medium ${
              activeTab === 'ads' ? 'bg-daladan-primary/10 text-daladan-primary' : 'text-slate-600'
            }`}
          >
            <CreditCard size={16} />
            E&apos;lonlarim
          ...
          <button
            ...
            className={`flex w-full items-center gap-2 rounded-lg px-3 py-2 text-left font-medium ${
              activeTab === 'messages' ? 'bg-daladan-primary/10 text-daladan-primary' : 'text-slate-600'
            }`}
          >
          ...
          <button
            ...
            className={`flex w-full items-center gap-2 rounded-lg px-3 py-2 text-left font-medium ${
              activeTab === 'payments' ? 'bg-daladan-primary/10 text-daladan-primary' : 'text-slate-600'
            }`}
          >
            <Wallet size={16} />
            To&apos;lovlar
